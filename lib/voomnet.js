...
export function initVoomnet() {
  ...
  function seedData(){
    ...
    return { users, suppliers, requests, orders, receptions, notifications, meta:{ achCounter:5, bcCounter:2, seuilOffres:0, tva:0, poids:{prix:50, delai:20, garantie:20, paiement:10} } };
  }
  ...
  function printRequest(requestId){
    ...
    $('#print-root').innerHTML = `
      ...
      <p style="margin-top:8px;font-size:11px;color:#64748b">Les colonnes « prix » laissées vides sont à compléter après consultation des fournisseurs.</p>
